...
HD_PWD='/home/iavendano/RISC-V-On-PYNQ/riscvonpynq/flute/tcm/flute/flute.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log flute_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source flute_wrapper.tcl -notrace
