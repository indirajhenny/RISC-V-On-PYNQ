...
HD_PWD='/home/iavendano/RISC-V-On-PYNQ/riscvonpynq/flute/tcm/flute/flute.runs/flute_procProtocolConv_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flute_procProtocolConv_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flute_procProtocolConv_0.tcl
