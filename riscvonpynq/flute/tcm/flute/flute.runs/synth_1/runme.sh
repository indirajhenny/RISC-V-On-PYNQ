...
HD_PWD='/home/iavendano/RISC-V-On-PYNQ/riscvonpynq/flute/tcm/flute/flute.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flute_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flute_wrapper.tcl
