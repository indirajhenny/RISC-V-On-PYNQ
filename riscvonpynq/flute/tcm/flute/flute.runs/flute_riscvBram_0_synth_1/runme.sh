...
HD_PWD='/home/iavendano/RISC-V-On-PYNQ/riscvonpynq/flute/tcm/flute/flute.runs/flute_riscvBram_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log flute_riscvBram_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source flute_riscvBram_0.tcl
