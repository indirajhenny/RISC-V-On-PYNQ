...
################################################################
# This is a generated script based on design: flute
#
...
proc create_hier_cell_orcaLmbProcessor { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_AXI_DMEM
  create_bd_intf_pin -mode Slave -vlnv xilinx.com:interface:aximm_rtl:1.0 S_AXI_MEM

  # Create pins
  create_bd_pin -dir O irq
  create_bd_pin -dir O m_axi_dmem_aclk
  create_bd_pin -dir O -from 0 -to 0 m_axi_dmem_aresetn
  ...
  # Create instance: flute3_0, and set properties
  set flute3_0 [ create_bd_cell -type ip -vlnv user.org:user:flute3:1.0 flute3_0 ]
 ...
 ] [get_bd_intf_pins /orcaLmbProcessor/flute3_0/cpu_dmem_master]
  ...
  set_property -dict [ list \
   ...
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
   CONFIG.MAX_BURST_LENGTH {1} \
 ] [get_bd_intf_pins /orcaLmbProcessor/flute3_0/cpu_imem_master]

  set_property -dict [ list \
   CONFIG.NUM_READ_OUTSTANDING {1} \
   CONFIG.NUM_WRITE_OUTSTANDING {1} \
 ] [get_bd_intf_pins /orcaLmbProcessor/flute3_0/cpu_slave]
  ...
  connect_bd_intf_net -intf_net flute3_0_cpu_dmem_master [get_bd_intf_pins flute3_0/cpu_dmem_master] [get_bd_intf_pins procXbar/S00_AXI]
  connect_bd_intf_net -intf_net flute3_0_cpu_imem_master [get_bd_intf_pins flute3_0/cpu_imem_master] [get_bd_intf_pins procXbar/S01_AXI]
  ...
  connect_bd_intf_net -intf_net psClockConv_M_AXI [get_bd_intf_pins flute3_0/cpu_slave] [get_bd_intf_pins psClockConv/M_AXI]
  ...
  connect_bd_net -net riscvReset_peripheral_aresetn [get_bd_pins m_axi_dmem_aresetn] [get_bd_pins flute3_0/RST_N] [get_bd_pins procBramController/s_axi_aresetn] [get_bd_pins procProtocolConv/aresetn] [get_bd_pins procXbar/aresetn] [get_bd_pins psClockConv/m_axi_aresetn] [get_bd_pins riscvReset/peripheral_aresetn]
  ...
  connect_bd_net -net subprocessorClk [get_bd_pins m_axi_dmem_aclk] [get_bd_pins riscv_clk] [get_bd_pins flute3_0/CLK] [get_bd_pins procBramController/s_axi_aclk] [get_bd_pins procProtocolConv/aclk] [get_bd_pins procXbar/aclk] [get_bd_pins psClockConv/m_axi_aclk] [get_bd_pins riscvReset/slowest_sync_clk]
...
proc create_root_design { parentCell } {
  ...
  create_bd_addr_seg -range 0x00008000 -offset 0x60000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs orcaLmbProcessor/flute3_0/cpu_slave/reg0] SEG_flute3_0_reg0
  ...
  create_bd_addr_seg -range 0x00001000 -offset 0x00000000 [get_bd_addr_spaces orcaLmbProcessor/flute3_0/cpu_dmem_master] [get_bd_addr_segs orcaLmbProcessor/procBramController/S_AXI/Mem0] SEG_procBramController_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0x00000000 [get_bd_addr_spaces orcaLmbProcessor/flute3_0/cpu_imem_master] [get_bd_addr_segs orcaLmbProcessor/procBramController/S_AXI/Mem0] SEG_procBramController_Mem0
  create_bd_addr_seg -range 0x00001000 -offset 0x80000000 [get_bd_addr_spaces orcaLmbProcessor/flute3_0/cpu_dmem_master] [get_bd_addr_segs psInterruptController/S_AXI/Reg] SEG_psInterruptController_Reg
  create_bd_addr_seg -range 0x00001000 -offset 0x80000000 [get_bd_addr_spaces orcaLmbProcessor/flute3_0/cpu_imem_master] [get_bd_addr_segs psInterruptController/S_AXI/Reg] SEG_psInterruptController_Reg
