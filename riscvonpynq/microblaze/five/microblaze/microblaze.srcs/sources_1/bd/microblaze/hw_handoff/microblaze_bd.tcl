...
proc create_hier_cell_microblazeLmbProcessor { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_AXI_DUC
  ...
  create_bd_pin -dir I -type clk s_axi_mem_aclk
  create_bd_pin -dir I -type rst s_axi_mem_aresetn
  ...
  # Create instance: softProcessorBram, and set properties
  set softProcessorBram [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 softProcessorBram ]
  set_property -dict [ list \
  ...
  # Create instance: softProcessorLmbCtrl, and set properties
  set softProcessorLmbCtrl [ create_bd_cell -type ip -vlnv xilinx.com:ip:lmb_bram_if_cntlr:4.0 softProcessorLmbCtrl ]
  set_property -dict [ list \
   CONFIG.C_NUM_LMB {2} \
 ] $softProcessorLmbCtrl

  # Create instance: softProcessorReset, and set properties
  set softProcessorReset [ create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 softProcessorReset ]
  set_property -dict [ list \
...
proc create_root_design { parentCell } {
  ...
  # Create instance: softProcessorClk, and set properties
  set softProcessorClk [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.4 softProcessorClk ]
  set_property -dict [ list \
  ...
  # Create instance: softProcessorResetSlice, and set properties
  set softProcessorResetSlice [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlslice:1.0 softProcessorResetSlice ]
  set_property -dict [ list \
   CONFIG.DIN_FROM {0} \
   CONFIG.DIN_TO {0} \
   CONFIG.DIN_WIDTH {7} \
 ] $softProcessorResetSlice
