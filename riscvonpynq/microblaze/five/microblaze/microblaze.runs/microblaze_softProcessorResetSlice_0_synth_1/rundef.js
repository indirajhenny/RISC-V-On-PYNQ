...
ISEStep( "vivado",
         "-log microblaze_softProcessorResetSlice_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_softProcessorResetSlice_0.tcl" );
