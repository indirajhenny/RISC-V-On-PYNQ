...
HD_PWD='/home/iavendano/RISC-V-On-PYNQ/riscvonpynq/microblaze/three/microblaze/microblaze.runs/microblaze_softProcessorReset_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log microblaze_softProcessorReset_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source microblaze_softProcessorReset_0.tcl
