...
HD_PWD='/home/iavendano/RISC-V-On-PYNQ-Flute/riscvonpynq/picorv32/tut/tutorial/tutorial.runs/tutorial_auto_pc_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tutorial_auto_pc_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tutorial_auto_pc_1.tcl
